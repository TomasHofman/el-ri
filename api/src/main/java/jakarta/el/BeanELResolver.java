...
public class BeanELResolver extends ELResolver {
    ...
    public Object invoke(ELContext context, Object base, Object methodName, Class<?>[] paramTypes, Object[] params) {
        ...
        Method m = ELUtil.findMethod(base.getClass(), methodName.toString(),
        ...
        for (Object p: params) {
            ...
            // for its evaluation
            if (p instanceof jakarta.el.LambdaExpression) {
                ((jakarta.el.LambdaExpression) p).setELContext(context);
            }
        }
